...
export default {
  ...
  darkMode: ["class"],
	...
	theme: {
      ...
      screens: {
        'ios': {'raw': '(max-device-width: 812px) and (-webkit-min-device-pixel-ratio: 2)'},
        'ios-landscape': {'raw': '(max-device-height: 414px) and (orientation: landscape)'},
      },
      spacing: {
