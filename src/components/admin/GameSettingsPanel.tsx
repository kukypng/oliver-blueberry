...
export const GameSettingsPanel: React.FC = () => {
  const { settings, isLoading, updateSettings } = useGameSettings();
      ...
      <CardContent className="space-y-6">
        ...
        <div className="space-y-4">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-lg font-semibold">Bug Crítico Ultrarrápido 🐛</h3>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                max="100"
                step="0.1"
                value={(formData.speed_bug_spawn_rate * 100).toFixed(1)}
                onChange={(e) => {
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                max="10"
                step="0.1"
                value={formData.speed_bug_speed_multiplier}
                onChange={(e) => {
                  const value = e.target.value;
                  if (value === '') return; // Não permite campo vazio
                  const numValue = parseFloat(value);
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                min="0"
                max="100"
                value={formData.bug_spawn_percentage}
                onChange={(e) => {
                  const value = e.target.value;
                  if (value === '') return; // Não permite campo vazio
                  const numValue = parseFloat(value);
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <Switch
                id="sound-enabled"
                checked={formData.hit_sound_enabled}
              ...
              <div className="space-y-2">
                ...
                <div className="px-3">
                  <Slider
                    ...
                    max={1}
                    step={0.1}
                    value={[formData.hit_sound_volume]}
