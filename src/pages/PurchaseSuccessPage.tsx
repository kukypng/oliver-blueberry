      ...
      <div className="relative z-10 container mx-auto px-4 py-20">
        ...
        <div className="text-center mb-16 animate-fade-in">
          <div className="flex items-center justify-center space-x-2 mb-6">
            <img src={appInfo.logoPath} alt={`${appInfo.name} Logo`} className="h-12 w-12" />
            <h1 className="text-4xl font-bold text-foreground">{appInfo.name}</h1>
          </div>
        </div>
          ...
          <Card className="glass-card animate-scale-in border-0 shadow-2xl backdrop-blur-xl relative overflow-hidden">
            <CardHeader className="text-center pb-6 pt-8">
              ...
              <CardDescription className="text-base">
                Obrigado por escolher o {appInfo.name} para sua assistência técnica
              </CardDescription>
            </CardHeader>
            ...
            <CardContent className="space-y-6">
              <div className="bg-primary/10 border border-primary/20 rounded-lg p-4">
                ...
                <ol className="list-decimal list-inside space-y-2 text-sm text-muted-foreground">
                  ...
                  <li>Comece a usar o {appInfo.name} imediatamente!</li>
                </ol>
              </div>

              {/* WhatsApp Contact Button */}
              <Button onClick={() => window.open(contacts.getWhatsAppUrl(), '_blank')} className="w-full h-12 text-base bg-green-600 hover:bg-green-700 text-white font-semibold rounded-xl transition-all duration-200 hover:scale-[1.02] active:scale-[0.98] shadow-lg hover:shadow-xl" size="lg">
              ...
              <div className="text-center pt-4 border-t border-border/50">
                <p className="text-sm text-muted-foreground mb-2">
                  <strong>WhatsApp:</strong> {contacts.whatsapp.fullNumber}
                </p>
